...
<div class="content-container">
  <div class="container">
    <h4 class="text-center">SCHOOLS/CLUBS
      <button class="btn btn-primary btn-rounded" data-bs-toggle="modal" data-bs-target="#addSchoolModal"
        id="add_SchoolButton">Add
        School</button>
    </h4>
    <p class="text-center">So far we have
      <?php echo $count_schools ?> Schools/Clubs, To Add new school click "Add School" button and fill all inputs!
    </p>
    ...
    <table class="table" id="myTable">
      ...
      <tbody>
        <?php foreach ($schools as $index => $data): ?>
          <tr>
            <td>
              <?php echo $index + 1 ?>
            </td>
            ...
            <td>
              <?php echo $data['ward'] . '  WARD' ?>
            </td>
            <td><a href="<?php echo route_to('/teachers/club/', $data['id']) ?>" class="studentClub btn btn-success"><i
                  class="fas fa-forward"></i></a>
            </td>
            <td><a href="<?php echo route_to('/students/club/', $data['id']) ?>" class="studentClub btn btn-success"><i
                  class="fas fa-forward"></i></a>
            </td>
            <td class="removed_school_id" id="<?php echo $data['id'] ?>"><button class=" btn btn-danger"><i
      ...
      <div class="modal-body">
        ...
        <form id="schoolForm" method="POST" action="#">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="schoolName" name="school" required>
          </div>

          <div class="mb-3">
            <label for="schoolType" class="form-label">Ward</label>
            <input type="text" class="form-control" id="schoolType" name="ward" required>
            <div id="schoolTypeDropdown" class="dropdown"></div>
          </div>

          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
            <button type="submit" class="btn btn-primary" id="saveSchoolButton">Save School</button>
          </div>
        </form>
...
include "jsProcess/addNewSchool.php";
include "jsProcess/removeSchool.php";
?>
